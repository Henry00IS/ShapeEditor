...
namespace AeternumGames.ShapeEditor
{
    ...
    public class PolyboolToPolygon
    {
        ...
        public List<Polygon> FromPolyboolPolygon(PolyBool polyBool, PolyboolPolygon poly)
        {
        ...
        private bool regionInsideRegion(Region r1, Region r2)
        {
        ...
        private MyNode newNode(Region region)
        {
            return new MyNode(region);
        }

        private void addChild(MyNode root, Region region)
        {
        ...
        private Region forceWinding(Region region, bool clockwise)
        {
        ...
        private void addExterior(MyNode node, List<Region> polygons)
        {
        ...
        private Region getInterior(MyNode node, List<Region> polygons)
        {
